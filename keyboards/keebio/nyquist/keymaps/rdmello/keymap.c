...
#define RYLAN_LAYOUT(...) LAYOUT_ortho_5x12( \
   __VA_ARGS__, \
   ADJUST, RAISE, LOWER, KC_LCTL, LOWER, GUI_T(KC_SPC),      KC_SPC, RAISE, KC_LALT, KC_LCTL, RAISE, _______ \
)
...
/*
 * Game - This layer is like QWERTY but with some slight modifications.
 */
[_GAME] = LAYOUT_ortho_5x12( \
  ...
  CTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,       KC_K,    KC_L, KC_SCLN, KC_QUOT,   \
  KC_LSFT,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT, KC_SLSH, KC_SFTENT, \
  ADJUST, RAISE, LOWER, KC_LCTL, GAMEMOD, KC_ENT,      KC_SPC, LOWER, KC_LCTL, KC_LALT, RAISE, _______
),

/*
 * GameModifiers - This layer is like LOWER but with some slight modifications.
 */
[_GAMEMOD] = LAYOUT_ortho_5x12( \
  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, \
  KC_TAB,  _______, KC_UP,   _______, _______, QWERTY,   _______, _______, _______, _______, _______, _______, \
  KC_ESC,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,  _______, _______, _______, _______, _______, _______, \
...
[_ADJUST] = LAYOUT_ortho_5x12( \
  _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
  KC_ACL2, KC_MUTE, KC_VOLU, _______, _______,  QWERTY,       _______, _______, _______, _______, _______, _______, \
  KC_ACL1, KC_BRID, KC_VOLD, KC_BRIU, _______,    GAME,       _______, _______, _______, _______, _______,  KC_F12, \
